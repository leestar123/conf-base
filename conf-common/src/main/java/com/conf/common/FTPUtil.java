...
public class FTPUtil {
	 ...
	 * @param locaFileName
	 */
	public void download(FTPClient ftp, String remoteFileName, String locaFileName) throws Exception {
	...
	private void connect(FTPClient ftp) throws Exception {
		...
		if (!FTPReply.isPositiveCompletion(reply)) {
			throw new ConnectException(server + " Server connect is rejected");
		}
		// 登陆
		if (!ftp.login(username, password)) {
			throw new ConnectException("Username or password is error");
		}
	}
}
